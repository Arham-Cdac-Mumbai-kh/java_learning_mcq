...
const seedData = async () => {
    try {
        ...
        for (const collection of remainingCollections) {
            ...
            } else if (collection === 'topics' || collection === 'mcqs') {
                // For topics and mcqs, we MUST keep the 'id' field because the model requires it
            } else {
                // For other collections, just remove the generic JSON id
